...
template<typename T>
void solve_frame(const T* prevInput, const T* curInput, const T* curProcessed, const T* prevSolution, T* curSolution, T* optflowBackward, int W, int H, double lambda_t, bool isFirstFrame) {
